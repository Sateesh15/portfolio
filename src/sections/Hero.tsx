...
export const Hero: React.FC<HeroProps> = ({ onCopySnippet }) => {
  ...
  return (
    <section 
      id="hero" 
      className="relative min-h-[92vh] flex items-center justify-center pt-28 pb-16 px-4 sm:px-6 lg:px-8 bg-grid-pattern bg-radial-gradient overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full text-xs font-mono font-medium bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 mb-6 shadow-lg shadow-emerald-500/5 hover:border-emerald-400/60 transition-all hover:scale-105 cursor-default">
          ...
          <div className="flex flex-wrap items-center gap-3 text-xs sm:text-sm font-mono text-slate-400 mb-8">
            <div className="flex items-center gap-2 bg-dark-850/90 px-3.5 py-2 rounded-xl border border-slate-800 hover:border-emerald-500/40 transition-all hover:translate-y-[-2px]">
              <MapPin className="w-4 h-4 text-emerald-400 animate-pulse" />
              <span>{personalProfile.location}</span>
            </div>
            <div className="flex items-center gap-2 bg-dark-850/90 px-3.5 py-2 rounded-xl border border-slate-800 hover:border-cyan-500/40 transition-all hover:translate-y-[-2px]">
              <Briefcase className="w-4 h-4 text-cyan-400" />
              <span>Spring Boot & Microservices</span>
            </div>
            <div className="flex items-center gap-2 bg-dark-850/90 px-3.5 py-2 rounded-xl border border-slate-800 hover:border-purple-500/40 transition-all hover:translate-y-[-2px]">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-8 w-full sm:w-auto">
            <a
              href="#projects"
              className="relative group inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl font-bold text-sm bg-emerald-500 hover:bg-emerald-400 text-dark-950 shadow-xl shadow-emerald-500/25 transition-all hover:scale-[1.03] active:scale-95 w-full sm:w-auto text-center overflow-hidden"
            >
          ...
          <div className="flex items-center gap-3 pt-4 border-t border-slate-800/80 w-full">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2.5 rounded-xl bg-dark-850 border border-slate-800 text-slate-400 hover:text-white hover:bg-[#0077b5] hover:border-[#0077b5] hover:scale-110 active:scale-95 transition-all shadow-sm"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2.5 rounded-xl bg-dark-850 border border-slate-800 text-slate-400 hover:text-white hover:bg-slate-700 hover:border-slate-600 hover:scale-110 active:scale-95 transition-all shadow-sm"
            ...
            <a
              ...
              className="p-2.5 rounded-xl bg-dark-850 border border-slate-800 text-slate-400 hover:text-white hover:bg-emerald-600 hover:border-emerald-500 hover:scale-110 active:scale-95 transition-all shadow-sm"
          ...
          <div className="relative rounded-2xl glass-panel border border-slate-700/80 shadow-2xl overflow-hidden group animated-gradient-border">
            ...
            <div className="flex items-center justify-between px-3 py-2.5 bg-dark-900/95 border-b border-slate-800 overflow-x-auto gap-2">
                ...
                {SNIPPETS.map((snippet) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-mono transition-all shrink-0 ${
                        isActive
              ...
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 rounded bg-dark-850 border border-slate-800 text-[11px] font-mono text-slate-300 hover:text-emerald-400 hover:border-emerald-500/40 transition-colors shrink-0"
