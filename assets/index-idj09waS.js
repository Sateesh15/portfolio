...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ss(e,t,n){let r=new Float32Array(qo),i=new U(0,1,0);return new Ha({name:`SphericalGaussianBlur`,defines:{n:qo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function cs(){return new Ha({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ls(){return new Ha({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:us(),fragmentShader:`
	...
	`}var ds=class extends ir{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new wa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
}`,highlights:{runtime:`Java 17`,framework:`Spring Boot 3`,keyFeature:`RBAC Security`}},{id:`security`,name:`SecurityConfig.java`,lang:`java`,icon:we,code:`// Azure Entra ID (SSO) & JWT Token Validator
@Configuration
@EnableWebSecurity
...
}`,highlights:{runtime:`OAuth2.0 / JWT`,framework:`Spring Security`,keyFeature:`Azure Entra ID`}},{id:`openai`,name:`OpenAIResumeParser.java`,lang:`java`,icon:Te,code:`// Azure OpenAI Semantic Extraction & Matching
@Service
...
}`,highlights:{runtime:`Splunk Log Agent`,framework:`Spring AOP`,keyFeature:`Real-time Metrics`}}],Xl=({onCopySnippet:e})=>{let[t,n]=(0,C.useState)(`rest`),[r,i]=(0,C.useState)(!1),[a,o]=(0,C.useState)(null),s=Yl.find(e=>e.id===t)||Yl[0];return(0,B.jsxs)(`section`,{id:`hero`,className:`relative min-h-[92vh] flex items-center justify-center pt-28 pb-16 px-4 sm:px-6 lg:px-8 bg-grid-pattern bg-radial-gradient overflow-hidden`,children:[(0,B.jsx)(`div`,{className:`absolute top-1/4 left-1/2 -translate-x-1/2 w-[550px] h-[550px] bg-emerald-500/10 rounded-full blur-[100px] pointer-events-none animate-pulse-subtle`}),(0,B.jsx)(`div`,{className:`absolute top-1/3 right-10 w-80 h-80 bg-cyan-500/10 rounded-full blur-[90px] pointer-events-none`}),(0,B.jsx)(`div`,{className:`absolute bottom-10 left-10 w-72 h-72 bg-purple-500/10 rounded-full blur-[90px] pointer-events-none`}),(0,B.jsxs)(`div`,{className:`max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10`,children:[(0,B.jsxs)(`div`,{className:`lg:col-span-7 flex flex-col items-start text-left`,children:[(0,B.jsxs)(`div`,{className:`inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full text-xs font-mono font-medium bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 mb-6 shadow-lg shadow-emerald-500/5 hover:border-emerald-400/60 transition-all hover:scale-105 cursor-default`,children:[(0,B.jsxs)(`span`,{className:`relative flex h-2.5 w-2.5`,children:[(0,B.jsx)(`span`,{className:`animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75`}),(0,B.jsx)(`span`,{className:`relative inline-flex rounded-full h-2.5 w-2.5 bg-emerald-500`})]}),(0,B.jsx)(`span`,{children:`4 Years Enterprise Experience • U.S. Client Engagements`})]}),(0,B.jsxs)(`div`,{className:`space-y-2 mb-4`,children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,B.jsxs)(`h2`,{className:`text-lg sm:text-xl font-mono text-emerald-400 font-semibold tracking-wide`,children:[`Hi, I'm `,z.preferredName]}),(0,B.jsx)(`span`,{className:`text-xl animate-bounce`,children:`👋`})]}),(0,B.jsxs)(`h1`,{className:`text-4xl sm:text-6xl lg:text-7xl font-extrabold text-slate-100 tracking-tight leading-none sm:leading-tight`,children:[`Java Full Stack `,(0,B.jsx)(`br`,{}),(0,B.jsx)(`span`,{className:`bg-gradient-to-r from-emerald-400 via-cyan-400 to-sky-400 bg-clip-text text-transparent drop-shadow-[0_0_25px_rgba(52,211,153,0.3)]`,children:`Developer`})]})]}),(0,B.jsxs)(`p`,{className:`text-base sm:text-lg text-slate-300 max-w-2xl leading-relaxed mb-6 font-normal`,children:[`Building high-throughput, resilient enterprise applications with `,(0,B.jsx)(`strong`,{className:`text-emerald-400 font-semibold`,children:`Java 17, Spring Boot, Microservices`}),`, and modern reactive frontends.`]}),(0,B.jsxs)(`div`,{className:`flex flex-wrap items-center gap-3 text-xs sm:text-sm font-mono text-slate-400 mb-8`,children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-2 bg-dark-850/90 px-3.5 py-2 rounded-xl border border-slate-800 hover:border-emerald-500/40 transition-all hover:translate-y-[-2px]`,children:[(0,B.jsx)(ge,{className:`w-4 h-4 text-emerald-400 animate-pulse`}),(0,B.jsx)(`span`,{children:z.location})]}),(0,B.jsxs)(`div`,{className:`flex items-center gap-2 bg-dark-850/90 px-3.5 py-2 rounded-xl border border-slate-800 hover:border-cyan-500/40 transition-all hover:translate-y-[-2px]`,children:[(0,B.jsx)(A,{className:`w-4 h-4 text-cyan-400`}),(0,B.jsx)(`span`,{children:`Spring Boot & Microservices`})]}),(0,B.jsxs)(`div`,{className:`flex items-center gap-2 bg-dark-850/90 px-3.5 py-2 rounded-xl border border-slate-800 hover:border-purple-500/40 transition-all hover:translate-y-[-2px]`,children:[(0,B.jsx)(Te,{className:`w-4 h-4 text-purple-400`}),(0,B.jsx)(`span`,{children:`Azure OpenAI & SSO`})]})]}),(0,B.jsxs)(`div`,{className:`flex flex-wrap items-center gap-4 mb-8 w-full sm:w-auto`,children:[(0,B.jsxs)(`a`,{href:`#projects`,className:`relative group inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl font-bold text-sm bg-emerald-500 hover:bg-emerald-400 text-dark-950 shadow-xl shadow-emerald-500/25 transition-all hover:scale-[1.03] active:scale-95 w-full sm:w-auto text-center overflow-hidden`,children:[(0,B.jsxs)(`span`,{className:`relative z-10 flex items-center gap-2`,children:[(0,B.jsx)(`span`,{children:`View My Projects`}),(0,B.jsx)(ee,{className:`w-4 h-4 group-hover:translate-x-1 transition-transform`})]}),(0,B.jsx)(`span`,{className:`absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity`})]}),(0,B.jsxs)(`a`,{href:z.resumePath,download:`Munnam-Sateesh-Resume.pdf`,target:`_blank`,rel:`noopener noreferrer`,className:`inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl font-bold text-sm bg-dark-850 hover:bg-dark-800 text-slate-200 border border-slate-700/90 hover:border-emerald-500/60 hover:text-emerald-400 shadow-lg transition-all hover:scale-[1.03] active:scale-95 w-full sm:w-auto text-center`,children:[(0,B.jsx)(ue,{className:`w-4 h-4 text-emerald-400`}),(0,B.jsx)(`span`,{children:`Download Resume`})]})]}),(0,B.jsxs)(`div`,{className:`flex items-center gap-3 pt-4 border-t border-slate-800/80 w-full`,children:[(0,B.jsx)(`span`,{className:`text-xs font-mono text-slate-500 mr-1`,children:`Connect:`}),(0,B.jsx)(`a`,{href:z.linkedin,target:`_blank`,rel:`noopener noreferrer`,className:`p-2.5 rounded-xl bg-dark-850 border border-slate-800 text-slate-400 hover:text-white hover:bg-[#0077b5] hover:border-[#0077b5] hover:scale-110 active:scale-95 transition-all shadow-sm`,"aria-label":`LinkedIn Profile`,title:`LinkedIn Profile`,children:(0,B.jsx)(Fe,{className:`w-4 h-4`})}),(0,B.jsx)(`a`,{href:z.github,target:`_blank`,rel:`noopener noreferrer`,className:`p-2.5 rounded-xl bg-dark-850 border border-slate-800 text-slate-400 hover:text-white hover:bg-slate-700 hover:border-slate-600 hover:scale-110 active:scale-95 transition-all shadow-sm`,"aria-label":`GitHub Profile`,title:`GitHub Profile`,children:(0,B.jsx)(Ie,{className:`w-4 h-4`})}),(0,B.jsx)(`a`,{href:`mailto:${z.email}`,className:`p-2.5 rounded-xl bg-dark-850 border border-slate-800 text-slate-400 hover:text-white hover:bg-emerald-600 hover:border-emerald-500 hover:scale-110 active:scale-95 transition-all shadow-sm`,"aria-label":`Email Munnam Sateesh`,title:`Email Directly`,children:(0,B.jsx)(he,{className:`w-4 h-4`})})]})]}),(0,B.jsxs)(`div`,{className:`lg:col-span-5 w-full relative`,children:[[{name:`Java 17`,color:`text-amber-400 border-amber-500/30 bg-amber-500/10`,pos:`-top-4 -left-4`,anim:`animate-float-slow`},{name:`Spring Boot`,color:`text-emerald-400 border-emerald-500/30 bg-emerald-500/10`,pos:`-top-6 -right-4`,anim:`animate-float-delayed`},{name:`Azure OpenAI`,color:`text-cyan-400 border-cyan-500/30 bg-cyan-500/10`,pos:`-bottom-5 -left-3`,anim:`animate-float-delayed`},{name:`Splunk`,color:`text-purple-400 border-purple-500/30 bg-purple-500/10`,pos:`-bottom-4 -right-3`,anim:`animate-float-slow`}].map((e,t)=>(0,B.jsxs)(`div`,{className:`absolute z-20 hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-[11px] font-mono font-bold border backdrop-blur-md shadow-xl ${e.color} ${e.pos} ${e.anim} transition-transform hover:scale-110 cursor-pointer`,onMouseEnter:()=>o(e.name),onMouseLeave:()=>o(null),children:[(0,B.jsx)(`span`,{className:`w-1.5 h-1.5 rounded-full bg-current`}),(0,B.jsx)(`span`,{children:e.name})]},t)),(0,B.jsxs)(`div`,{className:`relative rounded-2xl glass-panel border border-slate-700/80 shadow-2xl overflow-hidden group animated-gradient-border`,children:[(0,B.jsxs)(`div`,{className:`flex items-center justify-between px-3 py-2.5 bg-dark-900/95 border-b border-slate-800 overflow-x-auto gap-2`,children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-1.5 shrink-0`,children:[(0,B.jsx)(`span`,{className:`w-3 h-3 rounded-full bg-rose-500/80 inline-block`}),(0,B.jsx)(`span`,{className:`w-3 h-3 rounded-full bg-amber-500/80 inline-block`}),(0,B.jsx)(`span`,{className:`w-3 h-3 rounded-full bg-emerald-500/80 inline-block`})]}),(0,B.jsx)(`div`,{className:`flex items-center gap-1 overflow-x-auto py-0.5`,children:Yl.map(e=>{let r=e.icon,i=t===e.id;return(0,B.jsxs)(`button`,{onClick:()=>n(e.id),className:`flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-mono transition-all shrink-0 ${i?`bg-dark-800 text-emerald-400 border border-emerald-500/30 font-semibold shadow-inner`:`text-slate-400 hover:text-slate-200 hover:bg-dark-850`}`,children:[(0,B.jsx)(r,{className:`w-3 h-3`}),(0,B.jsx)(`span`,{className:`truncate max-w-[120px]`,children:e.name})]},e.id)})}),(0,B.jsx)(`button`,{onClick:()=>{navigator.clipboard.writeText(s.code),i(!0),e(s.code,`${s.name} copied to clipboard!`),setTimeout(()=>i(!1),2e3)},className:`flex items-center gap-1 px-2 py-1 rounded bg-dark-850 border border-slate-800 text-[11px] font-mono text-slate-300 hover:text-emerald-400 hover:border-emerald-500/40 transition-colors shrink-0`,title:`Copy code to clipboard`,children:r?(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(j,{className:`w-3 h-3 text-emerald-400`}),(0,B.jsx)(`span`,{className:`text-emerald-400`,children:`Copied!`})]}):(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(se,{className:`w-3 h-3`}),(0,B.jsx)(`span`,{children:`Copy`})]})})]}),(0,B.jsx)(`div`,{className:`p-4 font-mono text-[11px] sm:text-xs text-slate-300 overflow-x-auto bg-dark-950/95 leading-relaxed min-h-[220px]`,children:(0,B.jsx)(`pre`,{className:`text-slate-300 font-mono`,children:(0,B.jsx)(`code`,{children:s.code})})}),(0,B.jsxs)(`div`,{className:`px-4 py-3 bg-dark-900/90 border-t border-slate-800 grid grid-cols-3 gap-2 text-center text-[11px] font-mono`,children:[(0,B.jsxs)(`div`,{className:`p-1.5 rounded-lg bg-dark-850 border border-slate-800/80 hover:border-emerald-500/30 transition-colors`,children:[(0,B.jsx)(`span`,{className:`text-slate-500 block text-[10px]`,children:`Runtime`}),(0,B.jsx)(`span`,{className:`text-emerald-400 font-semibold`,children:s.highlights.runtime})]}),(0,B.jsxs)(`div`,{className:`p-1.5 rounded-lg bg-dark-850 border border-slate-800/80 hover:border-cyan-500/30 transition-colors`,children:[(0,B.jsx)(`span`,{className:`text-slate-500 block text-[10px]`,children:`Framework`}),(0,B.jsx)(`span`,{className:`text-cyan-400 font-semibold`,children:s.highlights.framework})]}),(0,B.jsxs)(`div`,{className:`p-1.5 rounded-lg bg-dark-850 border border-slate-800/80 hover:border-purple-500/30 transition-colors`,children:[(0,B.jsx)(`span`,{className:`text-slate-500 block text-[10px]`,children:`Key Feature`}),(0,B.jsx)(`span`,{className:`text-purple-400 font-semibold`,children:s.highlights.keyFeature})]})]})]})]})]})]})},Zl=({badge:e,title:t,subtitle:n,alignment:r=`center`})=>(0,B.jsxs)(`div`,{className:`flex flex-col mb-12 md:mb-16 ${r===`center`?`text-center items-center`:`text-left items-start`}`,children:[e&&(0,B.jsxs)(`div`,{className:`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-mono font-medium tracking-wide uppercase bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 mb-3 shadow-sm`,children:[(0,B.jsx)(`span`,{className:`w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse`}),e]}),(0,B.jsx)(`h2`,{className:`text-2xl md:text-4xl font-extrabold text-slate-100 tracking-tight`,children:t}),n&&(0,B.jsx)(`p`,{className:`mt-3 text-slate-400 text-sm md:text-base max-w-2xl leading-relaxed`,children:n}),(0,B.jsx)(`div`,{className:`mt-4 h-1 w-12 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-full `})]}),Ql=({children:e,className:t=``,maxTilt:n=8,glowColor:r=`rgba(16, 185, 129, 0.15)`,onClick:i})=>{let a=(0,C.useRef)(null),[o,s]=(0,C.useState)(`perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)`),[c,l]=(0,C.useState)({x:50,y:50,opacity:0});return(0,B.jsxs)(`div`,{ref:a,onMouseMove:e=>{if(!a.current)return;let t=a.current.getBoundingClientRect(),r=e.clientX-t.left,i=e.clientY-t.top,o=t.width/2,c=t.height/2,u=(i-c)/c*-n,d=(r-o)/o*n;s(`perspective(1000px) rotateX(${u.toFixed(2)}deg) rotateY(${d.toFixed(2)}deg) scale3d(1.015, 1.015, 1.015)`),l({x:r/t.width*100,y:i/t.height*100,opacity:1})},onMouseLeave:()=>{s(`perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)`),l(e=>({...e,opacity:0}))},onClick:i,style:{transform:o,transition:`transform 0.18s ease-out, box-shadow 0.25s ease`,transformStyle:`preserve-3d`,willChange:`transform`},className:`relative overflow-hidden cursor-pointer ${t}`,children:[(0,B.jsx)(`div`,{className:`pointer-events-none absolute inset-0 z-20 transition-opacity duration-300 rounded-inherit`,style:{background:`radial-gradient(circle 280px at ${c.x}% ${c.y}%, ${r}, transparent 80%)`,opacity:c.opacity}}),e]})},$l=()=>(0,B.jsx)(`section`,{id:`about`,className:`py-24 px-4 sm:px-6 lg:px-8 bg-dark-900/40 relative`,children:(0,B.jsxs)(`div`,{className:`max-w-7xl mx-auto`,children:[(0,B.jsx)(Zl,{badge:`Professional Background`,title:`About Me`,subtitle:`Engineering robust backend microservices and full-stack solutions for enterprise clients.`}),(0,B.jsxs)(`div`,{className:`grid grid-cols-1 lg:grid-cols-12 gap-10 items-start`,children:[(0,B.jsxs)(`div`,{className:`lg:col-span-6 space-y-6 text-slate-300 text-base leading-relaxed`,children:[(0,B.jsxs)(Ql,{maxTilt:4,glowColor:`rgba(16, 185, 129, 0.1)`,className:`p-7 sm:p-8 rounded-3xl bg-dark-850/90 border border-slate-800 shadow-2xl space-y-4 hover:border-emerald-500/40`,children:[(0,B.jsxs)(`h3`,{className:`text-xl sm:text-2xl font-bold text-slate-100 flex items-center gap-2.5`,children:[(0,B.jsx)(`span`,{className:`w-3 h-3 rounded-full bg-emerald-400 animate-pulse`}),`Munnam Sateesh — Java Full Stack Developer`]}),(0,B.jsxs)(`p`,{children:[`I am a dedicated `,(0,B.jsx)(`strong`,{className:`text-emerald-400 font-semibold`,children:`Java Full Stack Developer with 4 years of experience`}),` building mission-critical enterprise applications and microservices, primarily supporting U.S.-based client engagements in the energy and utility sectors.`]}),(0,B.jsxs)(`p`,{children:[`My core expertise centers on `,(0,B.jsx)(`strong`,{className:`text-slate-100`,children:`Java 17, Spring Boot, Spring Data JPA, Microservices, and REST APIs`}),`. On the frontend, I develop responsive, user-friendly client interfaces using `,(0,B.jsx)(`strong`,{className:`text-slate-100`,children:`Vue.js and React.js`}),`.`]}),(0,B.jsxs)(`p`,{children:[`Throughout my career at `,(0,B.jsx)(`strong`,{className:`text-slate-100`,children:`INU Technology Solutions`}),` and `,(0,B.jsx)(`strong`,{className:`text-slate-100`,children:`AvenData Technologies`}),`, I have contributed across the complete software development lifecycle: from initial architecture and secure authentication (Azure Entra ID, MSAL, RBAC) to automated testing (JUnit, Mockito, Selenium), Splunk observability, and strict SLA production support.`]}),(0,B.jsxs)(`div`,{className:`pt-2 flex flex-wrap gap-2 text-xs font-mono text-slate-300`,children:[(0,B.jsx)(`span`,{className:`px-3 py-1.5 rounded-xl bg-dark-800 border border-slate-700/80 hover:border-emerald-500/40 transition-colors`,children:`📍 Hyderabad, India`}),(0,B.jsx)(`span`,{className:`px-3 py-1.5 rounded-xl bg-dark-800 border border-slate-700/80 hover:border-emerald-500/40 transition-colors`,children:`⚡ Florida Power & Light (FPL)`}),(0,B.jsx)(`span`,{className:`px-3 py-1.5 rounded-xl bg-dark-800 border border-slate-700/80 hover:border-emerald-500/40 transition-colors`,children:`🏢 Central Hudson`})]})]}),(0,B.jsxs)(`div`,{className:`p-6 rounded-3xl bg-dark-850/50 border border-slate-800/80 space-y-3`,children:[(0,B.jsxs)(`h4`,{className:`text-xs font-mono uppercase text-slate-400 font-bold tracking-wider flex items-center gap-1.5`,children:[(0,B.jsx)(Te,{className:`w-3.5 h-3.5 text-emerald-400`}),`Engineering Tenets & Standards`]}),(0,B.jsxs)(`div`,{className:`grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-slate-300`,children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-2 p-2 rounded-lg bg-dark-900/60 border border-slate-800/60`,children:[(0,B.jsx)(N,{className:`w-4 h-4 text-emerald-400 shrink-0`}),(0,B.jsx)(`span`,{children:`Clean SOLID Architecture`})]}),(0,B.jsxs)(`div`,{className:`flex items-center gap-2 p-2 rounded-lg bg-dark-900/60 border border-slate-800/60`,children:[(0,B.jsx)(N,{className:`w-4 h-4 text-emerald-400 shrink-0`}),(0,B.jsx)(`span`,{children:`Test-Driven (JUnit / Vitest)`})]}),(0,B.jsxs)(`div`,{className:`flex items-center gap-2 p-2 rounded-lg bg-dark-900/60 border border-slate-800/60`,children:[(0,B.jsx)(N,{className:`w-4 h-4 text-emerald-400 shrink-0`}),(0,B.jsx)(`span`,{children:`Role-Based Access Control`})]}),(0,B.jsxs)(`div`,{className:`flex items-center gap-2 p-2 rounded-lg bg-dark-900/60 border border-slate-800/60`,children:[(0,B.jsx)(N,{className:`w-4 h-4 text-emerald-400 shrink-0`}),(0,B.jsx)(`span`,{children:`Telemetry & Splunk Logging`})]})]})]})]}),(0,B.jsx)(`div`,{className:`lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-5`,children:[{icon:Se,title:`Enterprise Java & Spring Boot`,desc:`4 years architecting resilient microservices, high-throughput REST APIs, and JPA data layers using Java 17 and Java 8.`,color:`text-emerald-400`,border:`hover:border-emerald-500/40`,bg:`bg-emerald-500/10`},{icon:pe,title:`Full Stack Capabilities`,desc:`Bridging backend services with modern responsive frontends using Vue.js and React.js for clean, intuitive workflows.`,color:`text-cyan-400`,border:`hover:border-cyan-500/40`,bg:`bg-cyan-500/10`},{icon:ae,title:`Cloud & AI Engineering`,desc:`Deploying scalable services across AWS and Azure, integrating Azure OpenAI LLMs, and securing auth with Azure Entra ID.`,color:`text-sky-400`,border:`hover:border-sky-500/40`,bg:`bg-sky-500/10`},{icon:O,title:`Production Support & Observability`,desc:`Proactive application monitoring via Splunk, SonarQube quality gates, and high-priority incident troubleshooting.`,color:`text-purple-400`,border:`hover:border-purple-500/40`,bg:`bg-purple-500/10`}].map((e,t)=>{let n=e.icon;return(0,B.jsx)(Ql,{maxTilt:8,glowColor:`rgba(16, 185, 129, 0.12)`,className:`p-6 rounded-3xl glass-card flex flex-col justify-between group ${e.border}`,children:(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`div`,{className:`w-12 h-12 rounded-2xl ${e.bg} border border-white/10 flex items-center justify-center ${e.color} mb-5 group-hover:scale-110 transition-transform shadow-inner`,children:(0,B.jsx)(n,{className:`w-6 h-6`})}),(0,B.jsx)(`h4`,{className:`text-base font-bold text-slate-100 mb-2 group-hover:text-emerald-400 transition-colors`,children:e.title}),(0,B.jsx)(`p`,{className:`text-xs text-slate-400 leading-relaxed`,children:e.desc})]})},t)})})]})]})}),eu=()=>{let[e,t]=(0,C.useState)(`all`),n=e=>{switch(e){case`Server`:return(0,B.jsx)(Se,{className:`w-5 h-5 text-emerald-400`});case`Code2`:return(0,B.jsx)(oe,{className:`w-5 h-5 text-cyan-400`});case`Layout`:return(0,B.jsx)(ye,{className:`w-5 h-5 text-sky-400`});case`Database`:return(0,B.jsx)(P,{className:`w-5 h-5 text-amber-400`});case`Cloud`:return(0,B.jsx)(ae,{className:`w-5 h-5 text-indigo-400`});case`CheckCircle2`:return(0,B.jsx)(N,{className:`w-5 h-5 text-rose-400`});case`ShieldCheck`:return(0,B.jsx)(Ce,{className:`w-5 h-5 text-emerald-400`});default:return(0,B.jsx)(oe,{className:`w-5 h-5 text-slate-400`})}},r=e===`all`?De:De.filter(t=>t.id===e);return(0,B.jsx)(`section`,{id:`skills`,className:`py-24 px-4 sm:px-6 lg:px-8 bg-dark-950 relative`,children:(0,B.jsxs)(`div`,{className:`max-w-7xl mx-auto`,children:[(0,B.jsx)(Zl,{badge:`Technical Competencies`,title:`Skills & Technologies`,subtitle:`A comprehensive overview of backend, full-stack, cloud, testing, and security competencies gained across 4 years of enterprise production experience.`}),(0,B.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2 mb-12`,children:[(0,B.jsxs)(`button`,{onClick:()=>t(`all`),className:`px-4 py-2 rounded-xl text-xs md:text-sm font-medium transition-all cursor-pointer active:scale-95 ${e===`all`?`bg-emerald-500 text-dark-950 font-bold shadow-lg shadow-emerald-500/25 scale-105`:`bg-dark-850 text-slate-400 hover:text-slate-200 border border-slate-800 hover:border-slate-700`}`,children:[`All Competencies (`,De.length,`)`]}),De.map(n=>(0,B.jsx)(`button`,{onClick:()=>t(n.id),className:`px-4 py-2 rounded-xl text-xs md:text-sm font-medium transition-all cursor-pointer active:scale-95 ${e===n.id?`bg-emerald-500 text-dark-950 font-bold shadow-lg shadow-emerald-500/25 scale-105`:`bg-dark-850 text-slate-400 hover:text-slate-200 border border-slate-800 hover:border-slate-700`}`,children:n.name},n.id))]}),(0,B.jsx)(`div`,{className:`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6`,children:r.map(e=>(0,B.jsxs)(Ql,{maxTilt:7,glowColor:`rgba(6, 182, 212, 0.12)`,className:`p-6 sm:p-7 rounded-3xl glass-card flex flex-col justify-between group hover:border-emerald-500/40 hover:shadow-xl hover:shadow-emerald-500/5 transition-all`,children:[(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-3 mb-4`,children:[(0,B.jsx)(`div`,{className:`w-12 h-12 rounded-2xl bg-dark-900 border border-slate-700/80 flex items-center justify-center group-hover:scale-110 group-hover:border-emerald-500/50 group-hover:shadow-[0_0_15px_rgba(52,211,153,0.2)] transition-all`,children:n(e.iconName)}),(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`h3`,{className:`text-base font-bold text-slate-100 group-hover:text-emerald-400 transition-colors`,children:e.name}),(0,B.jsxs)(`span`,{className:`text-[11px] font-mono text-emerald-400/90 flex items-center gap-1`,children:[(0,B.jsx)(L,{className:`w-3 h-3`}),e.skills.length,` core technologies`]})]})]}),(0,B.jsx)(`p`,{className:`text-xs text-slate-400 mb-6 leading-relaxed`,children:e.description}),(0,B.jsx)(`div`,{className:`flex flex-wrap gap-2`,children:e.skills.map(e=>(0,B.jsx)(ze,{name:e,variant:`default`,size:`sm`},e))})]}),(0,B.jsxs)(`div`,{className:`mt-6 pt-3.5 border-t border-slate-800/80 flex items-center justify-between text-[11px] font-mono text-slate-400`,children:[(0,B.jsxs)(`span`,{className:`flex items-center gap-1`,children:[(0,B.jsx)(N,{className:`w-3.5 h-3.5 text-emerald-400`}),`Enterprise Grade`]}),(0,B.jsx)(`span`,{className:`text-emerald-400 font-semibold`,children:`4 Yrs Applied`})]})]},e.id))}),(0,B.jsxs)(`div`,{className:`mt-12 p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-dark-900 via-dark-850 to-dark-900 border border-emerald-500/30 shadow-2xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6 animated-gradient-border`,children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-4 relative z-10`,children:[(0,B.jsx)(`div`,{className:`w-14 h-14 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center text-emerald-400 shrink-0 shadow-[0_0_20px_rgba(52,211,153,0.2)]`,children:(0,B.jsx)(Se,{className:`w-7 h-7`})}),(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`div`,{className:`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold bg-emerald-500/20 text-emerald-300 mb-1`,children:[(0,B.jsx)(Te,{className:`w-3 h-3`}),`PRIMARY CORE STACK`]}),(0,B.jsx)(`h4`,{className:`text-base sm:text-lg font-bold text-slate-100`,children:`Java 17 & Spring Boot Microservices Architecture`}),(0,B.jsx)(`p`,{className:`text-xs text-slate-400 mt-1 max-w-xl`,children:`Specialized in high-volume REST APIs, Spring Data JPA mappings, OAuth2/JWT security, Splunk log telemetry, and JUnit 5 test suites.`})]})]}),(0,B.jsxs)(`div`,{className:`flex flex-wrap gap-2 shrink-0 relative z-10`,children:[(0,B.jsx)(`span`,{className:`px-3.5 py-1.5 rounded-xl text-xs font-mono bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 font-bold shadow-sm`,children:`Java 17`}),(0,B.jsx)(`span`,{className:`px-3.5 py-1.5 rounded-xl text-xs font-mono bg-cyan-500/20 text-cyan-300 border border-cyan-500/40 font-bold shadow-sm`,children:`Spring Boot 3`}),(0,B.jsx)(`span`,{className:`px-3.5 py-1.5 rounded-xl text-xs font-mono bg-indigo-500/20 text-indigo-300 border border-indigo-500/40 font-bold shadow-sm`,children:`Microservices`})]})]})]})})},tu=()=>(0,B.jsx)(`section`,{id:`experience`,className:`py-20 px-4 sm:px-6 lg:px-8 bg-dark-900/30 relative`,children:(0,B.jsxs)(`div`,{className:`max-w-7xl mx-auto`,children:[(0,B.jsx)(Zl,{badge:`Career Journey`,title:`Professional Experience`,subtitle:`4 years of enterprise software engineering experience delivering resilient backend services, cloud architectures, and modern web applications.`}),(0,B.jsx)(`div`,{className:`relative border-l-2 border-slate-800 ml-4 sm:ml-8 md:ml-12 pl-6 sm:pl-10 space-y-12`,children:Oe.map((e,t)=>(0,B.jsxs)(`div`,{className:`relative group`,children:[(0,B.jsx)(`div`,{className:`absolute -left-[31px] sm:-left-[47px] top-1.5 w-6 h-6 rounded-full bg-dark-900 border-2 border-emerald-500 flex items-center justify-center shadow-lg shadow-emerald-500/20 group-hover:scale-125 transition-transform`,children:(0,B.jsx)(`span`,{className:`w-2 h-2 rounded-full bg-emerald-400`})}),(0,B.jsxs)(`div`,{className:`p-6 sm:p-8 rounded-2xl glass-card border border-slate-800 hover:border-emerald-500/30 transition-all`,children:[(0,B.jsxs)(`div`,{className:`flex flex-col md:flex-row md:items-center justify-between gap-3 mb-4 pb-4 border-b border-slate-850`,children:[(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`div`,{className:`flex flex-wrap items-center gap-2`,children:[(0,B.jsx)(`span`,{className:`text-xs font-mono font-semibold px-2.5 py-0.5 rounded-md bg-emerald-500/10 text-emerald-400 border border-emerald-500/20`,children:e.role}),e.isCurrent&&(0,B.jsx)(`span`,{className:`text-xs font-mono px-2 py-0.5 rounded-md bg-cyan-500/10 text-cyan-300 border border-cyan-500/20`,children:`Current Role`})]}),(0,B.jsxs)(`h3`,{className:`text-xl sm:text-2xl font-extrabold text-slate-100 mt-1 flex items-center gap-2`,children:[(0,B.jsx)(re,{className:`w-5 h-5 text-emerald-400`}),e.company]})]}),(0,B.jsxs)(`div`,{className:`flex flex-col md:items-end text-xs sm:text-sm font-mono text-slate-400 gap-1`,children:[(0,B.jsxs)(`span`,{className:`flex items-center gap-1.5 text-slate-300 font-semibold`,children:[(0,B.jsx)(ie,{className:`w-4 h-4 text-emerald-400`}),e.period]}),e.location&&(0,B.jsxs)(`span`,{className:`flex items-center gap-1.5 text-slate-500`,children:[(0,B.jsx)(ge,{className:`w-3.5 h-3.5`}),e.location]})]})]}),e.summary&&(0,B.jsx)(`p`,{className:`text-sm text-slate-300 mb-6 leading-relaxed`,children:e.summary}),e.projects&&e.projects.length>0&&(0,B.jsxs)(`div`,{className:`space-y-6`,children:[(0,B.jsxs)(`h4`,{className:`text-xs font-mono uppercase tracking-wider text-emerald-400 font-semibold flex items-center gap-2`,children:[(0,B.jsx)(pe,{className:`w-4 h-4`}),`Key Client Engagements & Projects`]}),(0,B.jsx)(`div`,{className:`grid grid-cols-1 gap-6`,children:e.projects.map((e,t)=>(0,B.jsxs)(`div`,{className:`p-5 rounded-xl bg-dark-950/70 border border-slate-800/90 hover:border-slate-700 transition-colors`,children:[(0,B.jsx)(`div`,{className:`flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2`,children:(0,B.jsxs)(`h5`,{className:`text-base font-bold text-slate-100 flex items-center gap-2`,children:[(0,B.jsx)(`span`,{className:`w-1.5 h-1.5 rounded-full bg-emerald-400`}),e.name]})}),(0,B.jsx)(`p`,{className:`text-xs sm:text-sm text-slate-400 mb-4 leading-relaxed`,children:e.description}),(0,B.jsx)(`div`,{className:`mb-4 space-y-2`,children:e.responsibilities.map((e,t)=>(0,B.jsxs)(`div`,{className:`flex items-start gap-2.5 text-xs text-slate-300`,children:[(0,B.jsx)(N,{className:`w-3.5 h-3.5 text-emerald-400 shrink-0 mt-0.5`}),(0,B.jsx)(`span`,{children:e})]},t))}),(0,B.jsx)(`div`,{className:`flex flex-wrap gap-1.5 pt-3 border-t border-slate-850`,children:e.technologies.map(e=>(0,B.jsx)(ze,{name:e,variant:`subtle`,size:`sm`},e))})]},t))})]}),e.responsibilities&&e.responsibilities.length>0&&(0,B.jsxs)(`div`,{className:`space-y-2.5`,children:[(0,B.jsx)(`h4`,{className:`text-xs font-mono uppercase tracking-wider text-slate-400 font-semibold mb-3`,children:`Core Responsibilities`}),e.responsibilities.map((e,t)=>(0,B.jsxs)(`div`,{className:`flex items-start gap-3 text-xs sm:text-sm text-slate-300`,children:[(0,B.jsx)(N,{className:`w-4 h-4 text-emerald-400 shrink-0 mt-0.5`}),(0,B.jsx)(`span`,{children:e})]},t))]})]})]},e.id))})]})}),nu=({onSelectProject:e})=>(0,B.jsx)(`section`,{id:`projects`,className:`py-24 px-4 sm:px-6 lg:px-8 bg-dark-950 relative`,children:(0,B.jsxs)(`div`,{className:`max-w-7xl mx-auto`,children:[(0,B.jsx)(Zl,{badge:`Enterprise Portfolios`,title:`Featured Projects`,subtitle:`Real-world enterprise systems and platforms built with Java, Spring Boot microservices, cloud deployments, and AI integrations.`}),(0,B.jsx)(`div`,{className:`grid grid-cols-1 md:grid-cols-2 gap-8`,children:ke.map(t=>(0,B.jsxs)(Ql,{maxTilt:6,glowColor:`rgba(16, 185, 129, 0.12)`,onClick:()=>e(t),className:`rounded-3xl glass-card border border-slate-800 flex flex-col justify-between overflow-hidden group hover:border-emerald-500/50 hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-300`,children:[(0,B.jsxs)(`div`,{className:`p-7 sm:p-8 flex-1`,children:[(0,B.jsxs)(`div`,{className:`flex items-center justify-between gap-3 mb-4`,children:[(0,B.jsxs)(`span`,{className:`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-mono font-semibold bg-emerald-500/15 text-emerald-400 border border-emerald-500/30`,children:[(0,B.jsx)(re,{className:`w-3.5 h-3.5`}),t.clientOrContext]}),t.isPrivate?(0,B.jsxs)(`span`,{className:`inline-flex items-center gap-1.5 text-[11px] font-mono text-amber-300 bg-amber-500/10 px-2.5 py-0.5 rounded-full border border-amber-500/20`,children:[(0,B.jsx)(me,{className:`w-3 h-3`}),`Private Enterprise`]}):(0,B.jsx)(`span`,{className:`inline-flex items-center gap-1.5 text-[11px] font-mono text-cyan-300 bg-cyan-500/10 px-2.5 py-0.5 rounded-full border border-cyan-500/20`,children:`Active Deployment`})]}),(0,B.jsxs)(`h3`,{className:`text-xl sm:text-2xl font-bold text-slate-100 group-hover:text-emerald-400 transition-colors mb-3 flex items-center justify-between`,children:[(0,B.jsx)(`span`,{children:t.title}),(0,B.jsx)(k,{className:`w-5 h-5 text-slate-500 group-hover:text-emerald-400 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all`})]}),(0,B.jsx)(`p`,{className:`text-xs sm:text-sm text-slate-300 mb-6 leading-relaxed`,children:t.summary}),(0,B.jsxs)(`div`,{className:`mb-6 space-y-2.5 bg-dark-900/60 p-4 rounded-2xl border border-slate-800/80`,children:[(0,B.jsxs)(`h4`,{className:`text-[11px] font-mono uppercase text-slate-400 font-semibold tracking-wider flex items-center gap-1.5`,children:[(0,B.jsx)(ce,{className:`w-3.5 h-3.5 text-cyan-400`}),`Core Architecture & Engineering:`]}),(0,B.jsx)(`ul`,{className:`space-y-1.5`,children:t.contributions.slice(0,3).map((e,t)=>(0,B.jsxs)(`li`,{className:`flex items-start gap-2 text-xs text-slate-300`,children:[(0,B.jsx)(N,{className:`w-3.5 h-3.5 text-emerald-400 shrink-0 mt-0.5`}),(0,B.jsx)(`span`,{className:`line-clamp-2`,children:e})]},t))})]}),(0,B.jsx)(`div`,{className:`flex flex-wrap gap-1.5 pt-2`,children:t.technologies.map(e=>(0,B.jsx)(ze,{name:e,variant:`subtle`,size:`sm`},e))})]}),(0,B.jsxs)(`div`,{className:`p-4 sm:px-8 bg-dark-850/80 border-t border-slate-800/80 flex items-center justify-between gap-4`,children:[(0,B.jsx)(`span`,{className:`text-xs font-mono text-slate-400`,children:t.badge||`Enterprise Grade`}),(0,B.jsxs)(`button`,{type:`button`,className:`inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-emerald-500/10 hover:bg-emerald-500 text-emerald-400 hover:text-dark-950 text-xs font-bold border border-emerald-500/30 hover:border-emerald-500 transition-all active:scale-95 shadow-sm`,children:[(0,B.jsx)(le,{className:`w-3.5 h-3.5`}),(0,B.jsx)(`span`,{children:`Explore Architecture`})]})]})]},t.id))})]})}),ru=()=>{let e=e=>{switch(e){case`Sparkles`:return(0,B.jsx)(Te,{className:`w-6 h-6 text-emerald-400`});case`Shield`:return(0,B.jsx)(we,{className:`w-6 h-6 text-cyan-400`});case`Cloud`:return(0,B.jsx)(ae,{className:`w-6 h-6 text-sky-400`});case`Activity`:return(0,B.jsx)(O,{className:`w-6 h-6 text-purple-400`});default:return(0,B.jsx)(ae,{className:`w-6 h-6 text-slate-400`})}};return(0,B.jsx)(`section`,{id:`ai-cloud`,className:`py-24 px-4 sm:px-6 lg:px-8 bg-dark-900/40 relative`,children:(0,B.jsxs)(`div`,{className:`max-w-7xl mx-auto`,children:[(0,B.jsx)(Zl,{badge:`Specialized Expertise`,title:`AI & Cloud Engineering`,subtitle:`Modern enterprise integration involving Azure OpenAI, enterprise identity via Azure Entra ID, cloud services, and production telemetry.`}),(0,B.jsx)(`div`,{className:`grid grid-cols-1 md:grid-cols-2 gap-8`,children:Ae.map((t,n)=>(0,B.jsxs)(Ql,{maxTilt:6,glowColor:`rgba(139, 92, 246, 0.12)`,className:`p-7 sm:p-9 rounded-3xl glass-card border border-slate-800 flex flex-col justify-between group hover:border-purple-500/40 hover:shadow-2xl hover:shadow-purple-500/10 transition-all`,children:[(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-3.5 mb-5`,children:[(0,B.jsx)(`div`,{className:`w-13 h-13 p-3 rounded-2xl bg-dark-900 border border-slate-700/80 flex items-center justify-center group-hover:scale-110 group-hover:border-purple-500/50 group-hover:shadow-[0_0_20px_rgba(168,85,247,0.2)] transition-all`,children:e(t.icon)}),(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`span`,{className:`text-[11px] font-mono text-purple-400 uppercase tracking-wider font-bold`,children:[t.category,` Specialization`]}),(0,B.jsx)(`h3`,{className:`text-lg sm:text-xl font-bold text-slate-100 group-hover:text-purple-300 transition-colors`,children:t.title})]})]}),(0,B.jsx)(`p`,{className:`text-xs sm:text-sm text-slate-300 mb-6 leading-relaxed`,children:t.description}),(0,B.jsx)(`div`,{className:`space-y-2.5 mb-6 bg-dark-950/60 p-4 rounded-2xl border border-slate-800/80`,children:t.keyHighlights.map((e,t)=>(0,B.jsxs)(`div`,{className:`flex items-start gap-2.5 text-xs text-slate-300`,children:[(0,B.jsx)(N,{className:`w-4 h-4 text-purple-400 shrink-0 mt-0.5`}),(0,B.jsx)(`span`,{children:e})]},t))})]}),(0,B.jsx)(`div`,{className:`flex flex-wrap gap-1.5 pt-4 border-t border-slate-850`,children:t.skills.map(e=>(0,B.jsx)(ze,{name:e,variant:`subtle`,size:`sm`},e))})]},n))})]})})},iu=()=>(0,B.jsx)(`section`,{id:`education`,className:`py-24 px-4 sm:px-6 lg:px-8 bg-dark-950 relative`,children:(0,B.jsxs)(`div`,{className:`max-w-7xl mx-auto`,children:[(0,B.jsx)(Zl,{badge:`Credentials & Academics`,title:`Education & Certifications`,subtitle:`Academic engineering foundation complemented by continuous enterprise training in Java, Spring Boot, and Cloud architectures.`}),(0,B.jsxs)(`div`,{className:`grid grid-cols-1 lg:grid-cols-2 gap-8`,children:[(0,B.jsxs)(`div`,{className:`space-y-6`,children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-2.5 mb-2`,children:[(0,B.jsx)(`div`,{className:`w-8 h-8 rounded-xl bg-emerald-500/10 text-emerald-400 flex items-center justify-center`,children:(0,B.jsx)(fe,{className:`w-4 h-4`})}),(0,B.jsx)(`h3`,{className:`text-lg font-bold text-slate-100 font-mono`,children:`Academic Background`})]}),je.map((e,t)=>(0,B.jsxs)(Ql,{maxTilt:5,glowColor:`rgba(16, 185, 129, 0.12)`,className:`p-7 rounded-3xl glass-card border border-slate-800 space-y-4 hover:border-emerald-500/40`,children:[(0,B.jsx)(`span`,{className:`inline-block px-3 py-1 rounded-full text-xs font-mono font-bold bg-emerald-500/15 text-emerald-300 border border-emerald-500/30`,children:`Undergraduate Degree`}),(0,B.jsx)(`h4`,{className:`text-xl font-bold text-slate-100`,children:e.degree}),(0,B.jsx)(`p`,{className:`text-sm font-semibold text-slate-300`,children:e.field}),(0,B.jsxs)(`div`,{className:`pt-2 text-xs font-mono text-slate-400 space-y-1.5 border-t border-slate-800/80`,children:[(0,B.jsx)(`div`,{className:`text-slate-300 font-medium`,children:(0,B.jsx)(`span`,{children:e.institution})}),(0,B.jsxs)(`div`,{className:`flex items-center gap-1.5 text-slate-500`,children:[(0,B.jsx)(ge,{className:`w-3.5 h-3.5 text-emerald-400`}),(0,B.jsx)(`span`,{children:e.location})]})]})]},t))]}),(0,B.jsxs)(`div`,{className:`space-y-6`,children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-2.5 mb-2`,children:[(0,B.jsx)(`div`,{className:`w-8 h-8 rounded-xl bg-cyan-500/10 text-cyan-400 flex items-center justify-center`,children:(0,B.jsx)(ne,{className:`w-4 h-4`})}),(0,B.jsx)(`h3`,{className:`text-lg font-bold text-slate-100 font-mono`,children:`Professional Certifications & Training`})]}),Me.map((e,t)=>(0,B.jsxs)(Ql,{maxTilt:5,glowColor:`rgba(6, 182, 212, 0.12)`,className:`p-7 rounded-3xl glass-card border border-slate-800 space-y-4 hover:border-cyan-500/40`,children:[(0,B.jsxs)(`div`,{className:`flex items-center justify-between gap-2`,children:[(0,B.jsx)(`span`,{className:`inline-block px-3 py-1 rounded-full text-xs font-mono font-bold bg-cyan-500/15 text-cyan-300 border border-cyan-500/30`,children:e.status}),(0,B.jsx)(`span`,{className:`text-xs font-mono text-slate-400`,children:e.issuer})]}),(0,B.jsx)(`h4`,{className:`text-lg font-bold text-slate-100`,children:e.name}),(0,B.jsx)(`div`,{className:`flex flex-wrap gap-1.5 pt-2`,children:e.topics.map(e=>(0,B.jsx)(ze,{name:e,variant:`subtle`,size:`sm`},e))})]},t))]})]})]})}),au=()=>(0,B.jsx)(`section`,{id:`resume`,className:`py-24 px-4 sm:px-6 lg:px-8 bg-dark-900/30 relative`,children:(0,B.jsxs)(`div`,{className:`max-w-7xl mx-auto`,children:[(0,B.jsx)(Zl,{badge:`Curriculum Vitae`,title:`Resume & Qualifications`,subtitle:`Download my complete technical resume formatted specifically for technical recruiters, engineering directors, and hiring managers.`}),(0,B.jsxs)(Ql,{maxTilt:4,glowColor:`rgba(16, 185, 129, 0.15)`,className:`max-w-4xl mx-auto rounded-3xl p-8 sm:p-12 glass-panel border border-emerald-500/30 shadow-2xl relative overflow-hidden animated-gradient-border`,children:[(0,B.jsx)(`div`,{className:`absolute top-0 right-0 w-80 h-80 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none`}),(0,B.jsxs)(`div`,{className:`flex flex-col md:flex-row items-center justify-between gap-8 relative z-10`,children:[(0,B.jsxs)(`div`,{className:`space-y-4 text-left`,children:[(0,B.jsx)(`div`,{className:`w-13 h-13 p-3 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center text-emerald-400 shadow-[0_0_20px_rgba(52,211,153,0.2)]`,children:(0,B.jsx)(de,{className:`w-7 h-7`})}),(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`h3`,{className:`text-2xl sm:text-3xl font-extrabold text-slate-100`,children:[z.name,` — Resume`]}),(0,B.jsxs)(`p`,{className:`text-sm text-emerald-400 font-mono mt-1 font-semibold flex items-center gap-1.5`,children:[(0,B.jsx)(Te,{className:`w-3.5 h-3.5`}),`Java Full Stack Developer (4 Years Enterprise Experience)`]})]}),(0,B.jsxs)(`div`,{className:`grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs text-slate-300 pt-2`,children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,B.jsx)(N,{className:`w-4 h-4 text-emerald-400 shrink-0`}),(0,B.jsx)(`span`,{children:`Java 17 & Spring Boot Microservices`})]}),(0,B.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,B.jsx)(N,{className:`w-4 h-4 text-emerald-400 shrink-0`}),(0,B.jsx)(`span`,{children:`U.S. Utility Client Experience (FPL)`})]}),(0,B.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,B.jsx)(N,{className:`w-4 h-4 text-emerald-400 shrink-0`}),(0,B.jsx)(`span`,{children:`React.js & Vue.js Frontend`})]}),(0,B.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,B.jsx)(N,{className:`w-4 h-4 text-emerald-400 shrink-0`}),(0,B.jsx)(`span`,{children:`Azure OpenAI & Azure Entra ID`})]})]})]}),(0,B.jsxs)(`div`,{className:`flex flex-col items-center sm:items-end gap-3 shrink-0 w-full md:w-auto`,children:[(0,B.jsxs)(`a`,{href:z.resumePath,download:`Munnam-Sateesh-Resume.pdf`,target:`_blank`,rel:`noopener noreferrer`,className:`relative group inline-flex items-center justify-center gap-3 px-9 py-4 rounded-2xl font-bold text-sm bg-emerald-500 hover:bg-emerald-400 text-dark-950 shadow-xl shadow-emerald-500/25 transition-all hover:scale-[1.05] active:scale-95 w-full sm:w-auto text-center cursor-pointer overflow-hidden`,children:[(0,B.jsxs)(`span`,{className:`relative z-10 flex items-center gap-2`,children:[(0,B.jsx)(ue,{className:`w-5 h-5`}),(0,B.jsx)(`span`,{children:`Download Resume (PDF)`})]}),(0,B.jsx)(`span`,{className:`absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity`})]}),(0,B.jsx)(`span`,{className:`text-[11px] font-mono text-slate-400`,children:`PDF Format • Standard ATS-Friendly Layout`})]})]})]})]})}),ou=({onCopyText:e})=>{let[t,n]=(0,C.useState)({name:``,email:``,message:``}),[r,i]=(0,C.useState)(null),[a,o]=(0,C.useState)(!1),[s,c]=(0,C.useState)(`idle`),l=(t,n)=>{navigator.clipboard.writeText(t),i(n),e(t,`${n} copied to clipboard!`),setTimeout(()=>i(null),2500)};return(0,B.jsx)(`section`,{id:`contact`,className:`py-24 px-4 sm:px-6 lg:px-8 bg-dark-950 relative`,children:(0,B.jsxs)(`div`,{className:`max-w-7xl mx-auto`,children:[(0,B.jsx)(Zl,{badge:`Get in Touch`,title:`Contact & Hiring`,subtitle:`Interested in discussing a software engineering or full stack developer role? Let's connect directly via email, phone, or LinkedIn.`}),(0,B.jsxs)(`div`,{className:`grid grid-cols-1 lg:grid-cols-12 gap-10`,children:[(0,B.jsx)(`div`,{className:`lg:col-span-5 space-y-6`,children:(0,B.jsxs)(Ql,{maxTilt:5,glowColor:`rgba(16, 185, 129, 0.12)`,className:`p-7 sm:p-8 rounded-3xl glass-card border border-slate-800 space-y-6 hover:border-emerald-500/40`,children:[(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`h3`,{className:`text-xl sm:text-2xl font-bold text-slate-100 mb-1`,children:z.name}),(0,B.jsxs)(`p`,{className:`text-xs font-mono text-emerald-400 font-semibold`,children:[z.title,` • 4 Yrs Exp`]})]}),(0,B.jsxs)(`div`,{className:`space-y-4`,children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-3.5 text-sm text-slate-300`,children:[(0,B.jsx)(`div`,{className:`w-11 h-11 rounded-2xl bg-dark-900 border border-slate-800 flex items-center justify-center text-emerald-400 shrink-0`,children:(0,B.jsx)(ge,{className:`w-5 h-5`})}),(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`span`,{className:`text-[11px] text-slate-500 font-mono block`,children:`Location`}),(0,B.jsx)(`span`,{className:`font-medium text-slate-200`,children:z.location})]})]}),(0,B.jsxs)(`div`,{className:`flex items-center justify-between p-3.5 rounded-2xl bg-dark-900/90 border border-slate-800/80 hover:border-emerald-500/30 transition-colors group`,children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,B.jsx)(`div`,{className:`w-10 h-10 rounded-xl bg-emerald-500/10 text-emerald-400 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform`,children:(0,B.jsx)(he,{className:`w-5 h-5`})}),(0,B.jsxs)(`div`,{className:`overflow-hidden`,children:[(0,B.jsx)(`span`,{className:`text-[10px] text-slate-500 font-mono block`,children:`Direct Email`}),(0,B.jsx)(`a`,{href:`mailto:${z.email}`,className:`text-xs sm:text-sm font-semibold text-slate-200 hover:text-emerald-400 transition-colors truncate block`,children:z.email})]})]}),(0,B.jsx)(`button`,{type:`button`,onClick:()=>l(z.email,`Email`),className:`p-2.5 rounded-xl bg-dark-800 text-slate-400 hover:text-emerald-400 hover:bg-dark-700 transition-all cursor-pointer active:scale-95`,title:`Copy email address`,children:r===`Email`?(0,B.jsx)(j,{className:`w-4 h-4 text-emerald-400`}):(0,B.jsx)(se,{className:`w-4 h-4`})})]}),(0,B.jsxs)(`div`,{className:`flex items-center justify-between p-3.5 rounded-2xl bg-dark-900/90 border border-slate-800/80 hover:border-cyan-500/30 transition-colors group`,children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,B.jsx)(`div`,{className:`w-10 h-10 rounded-xl bg-cyan-500/10 text-cyan-400 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform`,children:(0,B.jsx)(be,{className:`w-5 h-5`})}),(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`span`,{className:`text-[10px] text-slate-500 font-mono block`,children:`Mobile / WhatsApp`}),(0,B.jsx)(`a`,{href:`tel:${z.phone.replace(/\s+/g,``)}`,className:`text-xs sm:text-sm font-semibold text-slate-200 hover:text-cyan-400 transition-colors block`,children:z.phone})]})]}),(0,B.jsx)(`button`,{type:`button`,onClick:()=>l(z.phone,`Phone`),className:`p-2.5 rounded-xl bg-dark-800 text-slate-400 hover:text-cyan-400 hover:bg-dark-700 transition-all cursor-pointer active:scale-95`,title:`Copy phone number`,children:r===`Phone`?(0,B.jsx)(j,{className:`w-4 h-4 text-emerald-400`}):(0,B.jsx)(se,{className:`w-4 h-4`})})]})]}),(0,B.jsxs)(`div`,{className:`pt-4 border-t border-slate-800 space-y-3`,children:[(0,B.jsx)(`span`,{className:`text-xs font-mono text-slate-400 font-semibold block`,children:`Professional Networks`}),(0,B.jsxs)(`div`,{className:`grid grid-cols-2 gap-3`,children:[(0,B.jsxs)(`a`,{href:z.linkedin,target:`_blank`,rel:`noopener noreferrer`,className:`flex items-center justify-center gap-2 px-4 py-3 rounded-2xl bg-dark-900 hover:bg-[#0077b5] text-slate-200 hover:text-white border border-slate-800 hover:border-[#0077b5] text-xs font-bold transition-all hover:scale-105 active:scale-95 shadow-sm`,children:[(0,B.jsx)(Fe,{className:`w-4 h-4`}),(0,B.jsx)(`span`,{children:`LinkedIn`})]}),(0,B.jsxs)(`a`,{href:z.github,target:`_blank`,rel:`noopener noreferrer`,className:`flex items-center justify-center gap-2 px-4 py-3 rounded-2xl bg-dark-900 hover:bg-slate-700 text-slate-200 hover:text-white border border-slate-800 hover:border-slate-600 text-xs font-bold transition-all hover:scale-105 active:scale-95 shadow-sm`,children:[(0,B.jsx)(Ie,{className:`w-4 h-4`}),(0,B.jsx)(`span`,{children:`GitHub`})]})]})]})]})}),(0,B.jsx)(`div`,{className:`lg:col-span-7`,children:(0,B.jsxs)(`div`,{className:`p-7 sm:p-9 rounded-3xl glass-card border border-slate-800 animated-gradient-border`,children:[(0,B.jsxs)(`div`,{className:`flex items-center gap-2.5 mb-6`,children:[(0,B.jsx)(`div`,{className:`w-9 h-9 rounded-xl bg-emerald-500/10 text-emerald-400 flex items-center justify-center`,children:(0,B.jsx)(ve,{className:`w-5 h-5`})}),(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`h3`,{className:`text-lg sm:text-xl font-bold text-slate-100`,children:`Send a Direct Message`}),(0,B.jsxs)(`span`,{className:`text-[11px] font-mono text-slate-400`,children:[`Dispatches directly to `,z.email]})]})]}),(0,B.jsxs)(`form`,{onSubmit:e=>{if(e.preventDefault(),!t.name||!t.email||!t.message){alert(`Please fill out all fields before submitting.`);return}o(!0);let r=encodeURIComponent(`Inquiry / Opportunity for Munnam Sateesh from ${t.name}`),i=encodeURIComponent(`Hi Sateesh,\n\n${t.message}\n\nBest regards,\n${t.name}\nEmail: ${t.email}`),a=`mailto:${z.email}?subject=${r}&body=${i}`;setTimeout(()=>{o(!1),c(`success`),window.location.href=a,setTimeout(()=>{n({name:``,email:``,message:``})},3e3)},600)},className:`space-y-5`,children:[(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`label`,{htmlFor:`contact-name`,className:`block text-xs font-mono text-slate-400 mb-1.5 font-semibold`,children:`Your Name / Organization *`}),(0,B.jsx)(`input`,{id:`contact-name`,type:`text`,required:!0,value:t.name,onChange:e=>n({...t,name:e.target.value}),placeholder:`e.g. Sarah Jenkins (Engineering Recruiter)`,className:`w-full px-4 py-3.5 rounded-2xl bg-dark-900/90 border border-slate-800 text-slate-200 placeholder-slate-600 text-sm focus:outline-none focus:border-emerald-500/70 focus:ring-2 focus:ring-emerald-500/20 transition-all`})]}),(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`label`,{htmlFor:`contact-email`,className:`block text-xs font-mono text-slate-400 mb-1.5 font-semibold`,children:`Your Email Address *`}),(0,B.jsx)(`input`,{id:`contact-email`,type:`email`,required:!0,value:t.email,onChange:e=>n({...t,email:e.target.value}),placeholder:`name@company.com`,className:`w-full px-4 py-3.5 rounded-2xl bg-dark-900/90 border border-slate-800 text-slate-200 placeholder-slate-600 text-sm focus:outline-none focus:border-emerald-500/70 focus:ring-2 focus:ring-emerald-500/20 transition-all`})]}),(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`label`,{htmlFor:`contact-message`,className:`block text-xs font-mono text-slate-400 mb-1.5 font-semibold`,children:`Message / Opportunity Details *`}),(0,B.jsx)(`textarea`,{id:`contact-message`,required:!0,rows:4,value:t.message,onChange:e=>n({...t,message:e.target.value}),placeholder:`Hello Sateesh, we came across your Java Full Stack profile and would like to discuss...`,className:`w-full px-4 py-3.5 rounded-2xl bg-dark-900/90 border border-slate-800 text-slate-200 placeholder-slate-600 text-sm focus:outline-none focus:border-emerald-500/70 focus:ring-2 focus:ring-emerald-500/20 transition-all resize-y`})]}),s===`success`&&(0,B.jsxs)(`div`,{className:`p-4 rounded-2xl bg-emerald-500/15 border border-emerald-500/40 text-emerald-300 text-xs font-medium flex items-center gap-3 animate-in fade-in duration-300`,children:[(0,B.jsx)(j,{className:`w-5 h-5 text-emerald-400 shrink-0`}),(0,B.jsxs)(`span`,{children:[`Your email client has opened with your message ready to send! You can also email directly at `,(0,B.jsx)(`strong`,{children:z.email}),`.`]})]}),(0,B.jsx)(`button`,{type:`submit`,disabled:a,className:`w-full py-4 rounded-2xl font-bold text-sm bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 text-dark-950 shadow-xl shadow-emerald-500/25 transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-98 hover:scale-[1.01]`,children:a?(0,B.jsx)(`span`,{children:`Opening email composer...`}):(0,B.jsxs)(B.Fragment,{children:[(0,B.jsx)(xe,{className:`w-4 h-4`}),(0,B.jsx)(`span`,{children:`Send Direct Message`})]})}),(0,B.jsxs)(`p`,{className:`text-[11px] text-slate-400 font-mono text-center pt-2`,children:[`⚡ Immediate contact: `,(0,B.jsx)(`a`,{href:`mailto:${z.email}`,className:`text-emerald-400 underline`,children:z.email}),` • `,(0,B.jsx)(`a`,{href:`tel:${z.phone.replace(/\s+/g,``)}`,className:`text-emerald-400 underline`,children:z.phone})]})]})]})})]})]})})};function su(){let[e,t]=(0,C.useState)(`hero`),[n,r]=(0,C.useState)(null),[i,a]=(0,C.useState)(!1),[o,s]=(0,C.useState)(``),[c,l]=(0,C.useState)(!1),u=(e,t)=>{s(t||`Copied to clipboard!`),l(!0),setTimeout(()=>{l(!1)},3e3)};return(0,C.useEffect)(()=>{let e=document.querySelectorAll(`section[id]`),n=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&t(e.target.id)})},{rootMargin:`-30% 0px -60% 0px`});return e.forEach(e=>n.observe(e)),()=>e.forEach(e=>n.unobserve(e))},[]),(0,B.jsxs)(`div`,{className:`min-h-screen bg-dark-950 text-slate-100 flex flex-col font-sans selection:bg-emerald-500/25 selection:text-emerald-300 relative`,children:[(0,B.jsx)(Ve,{}),(0,B.jsx)(Jl,{}),(0,B.jsx)(Pe,{activeSection:e}),(0,B.jsxs)(`main`,{className:`flex-1 relative z-10`,children:[(0,B.jsx)(Xl,{onCopySnippet:u}),(0,B.jsx)($l,{}),(0,B.jsx)(eu,{}),(0,B.jsx)(tu,{}),(0,B.jsx)(nu,{onSelectProject:e=>{r(e),a(!0)}}),(0,B.jsx)(ru,{}),(0,B.jsx)(iu,{}),(0,B.jsx)(au,{}),(0,B.jsx)(ou,{onCopyText:u})]}),(0,B.jsx)(Le,{}),(0,B.jsx)(Be,{project:n,isOpen:i,onClose:()=>{a(!1),setTimeout(()=>r(null),200)}}),(0,B.jsx)(Re,{message:o,isVisible:c,onClose:()=>l(!1)})]})}R.createRoot(document.getElementById(`root`)).render((0,B.jsx)(C.StrictMode,{children:(0,B.jsx)(su,{})}));